            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="p-2 mb-2 bg-light text-white d-flex align-items-center">
                            ...
                            <input type="number" class="form-control d-inline col-2" min="1" id="quantityInput" value="1">
                            <button type="button" class="btn btn-success  ml-2" id="btnAddDetail">Agregar</button>
                        </div>
                    </div>
                    <div class="form-group">
